...
wget  https://github.com/prometheus/prometheus/releases/download/v2.23.0/prometheus-2.36.0.linux-amd64.tar.gz
...
rm -rf prometheus-2.36.0.linux-amd64.tar.gz prometheus-2.23.0.linux-amd64
